...
export default function Halal() {
  ...
  const articleData = {
    headline: "100% Halal Commitment at Istanbul Mediterranean",
    description: "Istanbul Mediterranean is the top halal restaurant on the Las Vegas Strip. 100% halal-certified meats, authentic Mediterranean cuisine, and the best Turkish food in Las Vegas.",
    image: "https://www.istanbullv.com/halal/halal_hero.jpg",
    ...
    url: "https://www.istanbullv.com/halal"
  };
  ...
  const breadcrumbData = {
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Halal",
        item: "https://www.istanbullv.com/halal"
      }
    ]
  };

  // Aggregate all schema types for the halal page
  ...
  return (
    <>
      <SEOHead 
        title="Istanbul Mediterranean Halal Restaurant Las Vegas | 100% Halal Meat Certificate"
        description="Istanbul Mediterranean is the top halal restaurant on the Las Vegas Strip. 100% halal-certified meats, authentic Mediterranean cuisine, and the best Turkish food in Las Vegas. Order online or visit us today!"
        keywords="halal restaurant las vegas, halal turkish food, halal mediterranean cuisine, halal certified restaurant, halal meat las vegas"
        canonicalUrl="https://www.istanbullv.com/halal"
        ogType="article"
        ogImage="https://www.istanbullv.com/halal/halal_hero.jpg"
      />
