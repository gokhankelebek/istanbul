  ...
  return (
    <>
      ...
      <section className="relative h-[32vh] md:h-[40vh] flex items-center justify-center bg-charcoal mb-12 overflow-hidden" style={{background:'#1F1F1F'}}>
        <img src="/contact/contact_hero.jpg" alt="Contact Istanbul Mediterranean" className="absolute inset-0 w-full h-full object-cover object-center opacity-80" style={{zIndex:0}} loading="lazy" onError={e => e.target.style.display='none'} />
        ...
        <div className="relative z-10 text-center text-offwhite space-y-5 w-full flex flex-col items-center">
          <h1 className="font-poppins font-extrabold text-4xl md:text-5xl drop-shadow-lg">Contact Us</h1>
          <p className="text-lg md:text-xl max-w-xl mx-auto">We love hearing from you! Reach out for reservations, catering, or just to say hello.</p>
        </div>
      </section>
      ...
      <div className="container mx-auto py-8">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col justify-between border border-saffron/10">
            <h2 className="text-2xl font-semibold mb-4 text-primary">Istanbul Mediterranean Restaurant</h2>
            <div className="flex items-center gap-2 mb-2 text-herb">
              <FaMapMarkerAlt className="text-saffron text-xl" />
              <a href="https://maps.app.goo.gl/CyiQeyNp4X5PLDbL6" target="_blank" rel="noopener noreferrer" className="hover:underline">3615 S Las Vegas Blvd #101, Las Vegas, NV 89109</a>
            </div>
            <div className="flex items-center gap-2 mb-2 text-charcoal">
              <FaPhoneAlt className="text-istanbulRed text-lg" />
              <a href="tel:+17259008844" className="hover:underline">(725) 900-8844</a>
            </div>
            <div className="flex items-center gap-2 mb-2 text-charcoal">
              <FaEnvelope className="text-herb text-lg" />
              <a href="mailto:info@istanbullv.com" className="hover:underline">info@istanbullv.com</a>
            </div>
            <div className="flex items-center gap-2 mb-2 text-charcoal">
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://www.instagram.com/istanbulmediterraneanlv/" target="_blank" rel="noopener noreferrer" className="text-istanbulRed hover:text-istanbulRed-dark text-2xl"><FaInstagram /></a>
              <a href="https://www.facebook.com/istanbulmediterraneanlv/" target="_blank" rel="noopener noreferrer" className="text-istanbulRed hover:text-istanbulRed-dark text-2xl"><FaFacebook /></a>
            </div>
          </div>
          {/* Contact Form */}
          <form
          ...
          >
            ...
            <div className="relative">
              <input type="text" name="name" id="contact-name" className="peer border-b-2 border-gray-300 bg-transparent w-full px-1 py-3 focus:outline-none focus:border-istanbulRed transition-colors" required />
              <label htmlFor="contact-name" className="absolute left-1 top-0 text-gray-400 text-sm transition-all peer-focus:-top-5 peer-focus:text-xs peer-focus:text-istanbulRed peer-valid:-top-5 peer-valid:text-xs pointer-events-none">Your Name</label>
            </div>
            <div className="relative">
              <input type="email" name="email" id="contact-email" className="peer border-b-2 border-gray-300 bg-transparent w-full px-1 py-3 focus:outline-none focus:border-istanbulRed transition-colors" required />
              <label htmlFor="contact-email" className="absolute left-1 top-0 text-gray-400 text-sm transition-all peer-focus:-top-5 peer-focus:text-xs peer-focus:text-istanbulRed peer-valid:-top-5 peer-valid:text-xs pointer-events-none">Your Email</label>
            </div>
            <div className="relative">
      ...
      <section className="py-16 bg-white text-center border-t border-saffron/20 mt-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-4xl mx-auto">
          <div className="flex-1">
            ...
            <div className="mt-4">
              <a href="https://maps.app.goo.gl/CyiQeyNp4X5PLDbL6" target="_blank" rel="noopener noreferrer" className="btn btn-secondary">View on Google Maps</a>
            </div>
          </div>
