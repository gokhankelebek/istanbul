...
export default function Catering() {
  ...
  const serviceData = {
    name: "Turkish & Mediterranean Catering Service",
    description:
      "Let us bring the flavors of Istanbul to your next event! Perfect for parties, corporate events, weddings, and more. 100% halal certified.",
    provider: {
      "@type": "Restaurant",
    ...
    availableChannel: {
      "@type": "ServiceChannel",
      serviceUrl: "https://www.istanbullv.com/catering",
    },
    hoursAvailable: [
      {
  ...
  const breadcrumbData = {
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Catering",
        item: "https://www.istanbullv.com/catering",
      },
    ],
  };

  // Aggregate all schema types for the catering page
  ...
  return (
    <>
      <SEOHead
        title="Turkish & Mediterranean Catering Las Vegas | Istanbul Mediterranean"
        description="Let us bring the flavors of Istanbul to your next event! Perfect for parties, corporate events, weddings, and more. 100% halal certified catering in Las Vegas."
        keywords="turkish catering las vegas, mediterranean catering, halal catering, corporate catering, wedding catering, event catering las vegas"
        canonicalUrl="https://www.istanbullv.com/catering"
        ogType="website"
        ogImage="https://www.istanbullv.com/catering/catering_hero.jpg"
      />
      ...
      >
        <img
          src="/catering/catering_hero.jpg"
          alt="Catering at Istanbul Mediterranean"
        ...
        <div className="relative z-10 text-center text-offwhite space-y-5 w-full flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl max-w-xl mx-auto">
            Let us bring the flavors of Istanbul to your next event! Perfect for
            parties, corporate events, weddings, and more.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto text-center">
          <div className="flex flex-col items-center p-6 rounded-2xl shadow bg-white border border-saffron/10">
            ...
            <span className="text-herb text-sm">
              Traditional Turkish & Mediterranean dishes for every palate.
            </span>
          </div>
          <div className="flex flex-col items-center p-6 rounded-2xl shadow bg-white border border-saffron/10">
          ...
          <div className="flex flex-col items-center p-6 rounded-2xl shadow bg-white border border-saffron/10">
            ...
            <span className="text-herb text-sm">
              All meats are halal-certified and ethically sourced.
            </span>
          </div>
          <div className="flex flex-col items-center p-6 rounded-2xl shadow bg-white border border-saffron/10">
            ...
            <span className="text-herb text-sm">
              We work around your event needs and timing.
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-white via-offwhite to-saffron/10 text-center">
        ...
        <div className="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-saffron/10 flex flex-col items-center">
          <p className="mb-4 text-lg text-charcoal">
            Tell us about your event and we'll get back to you with a custom
            quote.
          </p>
          <form className="w-full flex flex-col gap-4">
            <input
              ...
              className="border-b-2 border-gray-300 bg-transparent px-2 py-3 focus:outline-none focus:border-istanbulRed transition-colors rounded"
              required
            />
            <input
              type="email"
            ...
            <textarea
              name="details"
              rows="3"
              placeholder="Event Details or Questions"
              className="border-b-2 border-gray-300 bg-transparent px-2 py-3 focus:outline-none focus:border-istanbulRed transition-colors rounded resize-none"
              required
            ></textarea>
          ...
          <div className="mt-6 text-herb text-base flex items-center gap-2 justify-center">
            ...
            <span>
              Or call us at{" "}
              <a href="tel:+17259008844" className="underline font-bold">
                (725) 900-8844
              </a>
            </span>
          </div>
