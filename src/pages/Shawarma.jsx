...
export default function ShawarmaPage() {
  return (
    <div className="px-6 py-12 max-w-5xl mx-auto space-y-14">
      <Helmet>
        <title>
          Best Shawarma in Las Vegas | Authentic Turkish Döner | Istanbul
          Mediterranean
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="shawarma las vegas, doner kebab, halal food las vegas, turkish food, mediterranean restaurant, authentic shawarma, best shawarma las vegas"
        />
        <meta
          property="og:title"
          content="Best Shawarma in Las Vegas | Istanbul Mediterranean"
        />
        <meta
          property="og:description"
          content="Authentic Turkish shawarma & döner kebab in Las Vegas. 100% halal, traditional preparation, fresh daily. Order now!"
        />
        <meta
          property="og:image"
          content="https://www.istanbullv.com/shawarma-vs-doner.webp"
        />
          ...
          <div className="absolute inset-0 bg-black bg-opacity-40 rounded-2xl flex items-center justify-center">
            <div className="text-white text-center px-4">
              ...
              <p className="text-lg md:text-xl drop-shadow-md max-w-3xl mx-auto">
                Everything you need to know about one of the world's most
      ...
      <section className="bg-gradient-to-r from-red-600 to-orange-600 text-white p-8 rounded-2xl text-center shadow-2xl">
        <h2 className="text-3xl font-bold mb-4">
          🔥 Try Our Authentic Shawarma Today!
        </h2>
        <p className="text-xl mb-6">
          Experience the same traditional flavors described below at Istanbul
          Mediterranean
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <p className="text-lg leading-relaxed">
              Shawarma is thinly sliced, spiced meat—lamb, beef, or
              chicken—cooked slowly on a vertical rotisserie. The meat
              self-bastes in its own juices, resulting in tender, flavorful
              slices served in flatbreads with tahini, garlic sauce, and pickled
              vegetables.
            </p>
          </div>
      ...
      <section className="space-y-6">
        ...
        <p>
          Shawarma evolved from the Turkish <em>döner kebab</em> in the Ottoman
          Empire during the 19th century. As the method spread to the Levant, it
          adapted into what we now call shawarma—meaning "turning" in Turkish.
          By the 20th century, Lebanese immigrants popularized it globally,
          influencing dishes like Mexico's <em>tacos al pastor</em>.
        </p>
      </section>
      ...
      <section className="space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-3">
          <li>
            Marinate thin slices of meat with spices (cumin, coriander, paprika,
            turmeric, garlic) plus olive oil and lemon juice.
          </li>
          <li>Stack the meat tightly onto a vertical spit and slow-roast.</li>
          <li>
            Shave off tender slices as the meat cooks, and serve immediately in
            wraps or plates with sides.
          </li>
        </ol>
      </section>
      ...
      <section className="space-y-8">
        <h2 className="text-3xl font-bold text-center">
          Our Authentic Shawarma Varieties
        </h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Traditional blend with rich Middle Eastern spices. The original
                and most authentic flavor profile.
              </p>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Yogurt-lemon marinated for extra tenderness. Light yet
                flavorful, perfect for health-conscious diners.
              </p>
              <div className="flex justify-between items-center">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Best of both worlds! Combination of beef, lamb, and chicken for
      ...
      <section className="space-y-6">
        ...
        <p>
          From Lebanon and Jordan to Germany and Mexico, shawarma has adapted
          into countless regional favorites. Variations include{" "}
          <em>tacos al pastor</em> in Mexico and lamb döner in Europe—each
          inspired by the same rotating-spit method.
        </p>
      </section>
      ...
      <section className="space-y-6">
        ...
        <p>
          Though similar in preparation, shawarma (Middle Eastern) is seasoned
          with bold spices, gyros (Greek) are made with Mediterranean herbs and
          tzatziki, and döner kebab (Turkish) features a more subtle flavor
          profile.
        </p>
      </section>
      ...
      <section className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-2xl space-y-6">
        <h2 className="text-3xl font-bold text-center">
          🎰 Best Shawarma in Las Vegas
        </h2>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-xl font-semibold mb-4">
              Why Istanbul Mediterranean?
            </h3>
            <ul className="space-y-3">
              <li className="flex items-center">
                <span className="text-green-600 mr-2">✓</span>
                <strong>Authentic Turkish preparation</strong> - Traditional
                vertical rotisserie method
              </li>
              <li className="flex items-center">
                <span className="text-green-600 mr-2">✓</span>
                <strong>100% Halal certified</strong> - Meeting the highest
                dietary standards
              </li>
              <li className="flex items-center">
                <span className="text-green-600 mr-2">✓</span>
                <strong>Fresh daily preparation</strong> - Never frozen, always
                made to order
              </li>
              <li className="flex items-center">
                <span className="text-green-600 mr-2">✓</span>
                <strong>Family recipes</strong> - Passed down through
                generations
              </li>
            </ul>
          </div>
      ...
      <section className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-blue-50 p-6 rounded-xl">
            ...
            <ul className="space-y-2">
              <li>
                • <strong>High protein</strong> supports muscle growth
              </li>
              <li>
                • <strong>Mediterranean spices</strong> have anti-inflammatory
                properties
              </li>
              <li>
                • <strong>Fresh vegetables</strong> provide essential vitamins
              </li>
              <li>
                • <strong>Tahini sauce</strong> contains healthy fats and
                calcium
              </li>
              <li>
                • <strong>No processed additives</strong> in traditional
                preparation
              </li>
            </ul>
          </div>
        ...
        <div className="text-center bg-yellow-50 p-6 rounded-xl">
          <h4 className="font-semibold text-yellow-800 mb-2">
            💡 Pro Tip for Healthier Shawarma:
          </h4>
          <p className="text-yellow-700">
            Choose lavash wrap instead of pita, extra vegetables, and request
            light sauce for a lower-calorie, nutrient-dense meal.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          <details className="p-4 border rounded-lg">
            ...
            <p className="mt-2">
              Shawarma originated in the Ottoman Empire and refers to spiced
              meat cooked on a rotating spit, a culinary tradition that evolved
              into today's Middle Eastern favorite.
            </p>
          </details>

          <details className="p-4 border rounded-lg">
            <summary className="font-semibold cursor-pointer">
              What ingredients are typically used in shawarma?
            </summary>
            <p className="mt-2">
              Typical shawarma includes cumin, paprika, turmeric, garlic, and
              lemon-marinated meats like lamb, beef, or chicken, wrapped with
              tahini or garlic sauces, pickles, and salads.
            </p>
          </details>
          ...
          <details className="p-4 border rounded-lg">
            ...
            <p className="mt-2">
              Marinate sliced meat in Middle Eastern spices and roast or bake.
              Serve thinly sliced meat in pita with toppings.
            </p>
          </details>
          ...
          <details className="p-4 border rounded-lg">
            ...
            <p className="mt-2">
              Yes, especially when made with lean meats, fresh vegetables, and
              lighter sauces. It's a great source of protein with moderate fat
          ...
          <details className="p-4 border rounded-lg">
            <summary className="font-semibold cursor-pointer">
              What's the difference between shawarma and döner kebab?
            </summary>
            <p className="mt-2">
              While both use the rotating spit method, döner kebab is Turkish
              with specific spice blends, while shawarma is Arab/Levantine with
              different seasonings and sauces. At Istanbul Mediterranean, we
              serve authentic Turkish döner kebab using traditional methods.
            </p>
          </details>

          <details className="p-4 border rounded-lg">
            <summary className="font-semibold cursor-pointer">
              Is your shawarma halal certified?
            </summary>
            <p className="mt-2">
              Yes! All our meats are 100% halal certified, ensuring they meet
              the highest Islamic dietary standards. We source from certified
              suppliers and maintain strict halal preparation methods.
            </p>
          </details>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-orange-500 to-red-600 text-white p-12 rounded-2xl text-center">
        <h2 className="text-4xl font-bold mb-4">
          🥙 Ready to Experience Authentic Shawarma?
        </h2>
        <p className="text-xl mb-8 max-w-2xl mx-auto">
          Don't just read about it - taste the difference that authentic Turkish
          preparation makes. Order from Istanbul Mediterranean and discover why
          we're Las Vegas's premier destination for halal Mediterranean cuisine.
        </p>
        ...
        <div className="mt-8 pt-8 border-t border-white border-opacity-20">
          <p className="text-lg opacity-90">
            📞 Call us:{" "}
            <a href="tel:+17028473300" className="underline hover:no-underline">
              (702) 847-3300
            </a>{" "}
            | 📍 Las Vegas, Nevada
          </p>
