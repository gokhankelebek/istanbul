...
export default function About() {
  return (
    <>
      {/* Hero Banner */}
      <section className="relative h-[38vh] md:h-[48vh] flex items-center justify-center bg-charcoal mb-12 overflow-hidden" style={{background:'#1F1F1F'}}>
        <img src="/about/about_hero.jpg" alt="About Istanbul Mediterranean" className="absolute inset-0 w-full h-full object-cover object-center opacity-80" style={{zIndex:0}} loading="lazy" onError={e => e.target.style.display='none'} />
        ...
        <div className="relative z-10 text-center text-offwhite space-y-5 w-full flex flex-col items-center">
          <h1 className="font-poppins font-extrabold text-4xl md:text-5xl drop-shadow-lg">About Istanbul Mediterranean</h1>
          <p className="text-lg md:text-2xl max-w-2xl mx-auto">Family-owned, halal-certified, and dedicated to authentic Turkish hospitality in the heart of Las Vegas.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-offwhite text-center">
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-charcoal mb-4">Istanbul Mediterranean was born from a passion for sharing the flavors and traditions of Turkey. Our family recipes are rooted in the bustling streets of Istanbul, passed down through generations and lovingly recreated in Las Vegas. We believe food is a celebration—of culture, of family, and of togetherness.</p>
            <div className="bg-white p-4 rounded-xl shadow mb-4 border-l-4 border-istanbulRed/70 max-w-xl mx-auto">
              <span className="italic text-saffron text-lg">“Cooking is our family’s passion. Every dish is a journey through history, crafted with love and served with a smile.”</span>
            </div>
            <div className="mt-6">
      ...
      <section className="py-16 bg-white">
        <h2 className="text-2xl font-bold mb-8 text-primary text-center">Why We’re Different</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center p-6 rounded-2xl shadow bg-offwhite border border-saffron/10">
            ...
            <span className="text-herb text-sm">We’re open until 5am for late-night cravings.</span>
          </div>
          <div className="flex flex-col items-center p-6 rounded-2xl shadow bg-offwhite border border-saffron/10">
            <FaHeart className="text-primary text-3xl mb-2" />
            <span className="font-bold text-lg mb-1">True Hospitality</span>
            <span className="text-herb text-sm">Every guest is treated like family—always.</span>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-4xl mx-auto">
          ...
          <div className="flex-1 text-lg text-charcoal">
            ...
            <div className="bg-white p-4 rounded-xl shadow border-l-4 border-herb/70 max-w-xl mx-auto">
              <span className="italic text-herb">“My greatest joy is seeing guests discover the flavors of my homeland. Welcome to our table!”</span>
            </div>
            <div className="mt-6">
              <span style={{ fontFamily: 'Pacifico, cursive', fontSize: '1.5rem', color: '#b48b3c', display: 'inline-block' }}>
                Chef Ahmet
              </span>
            </div>
          </div>
      ...
      <section className="py-12 bg-white text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 text-herb">
          ...
          <span className="text-lg">Stay tuned for our latest press features and awards!</span>
        </div>
      </section>
    </>
  );
